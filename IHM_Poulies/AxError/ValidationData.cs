...
namespace AxError
{
    public static class ValidationData
    {
        ...
        //        f = true;
        //    string id1, id2;
        //    if (p.ID1.ToString().Length == 2)
        //        id1 = "0" + p.ID1;
        //    else
        //    {
        //        if (p.ID1.ToString().Length == 1)
        //            id1 = "00" + p.ID1;
        //        else
        //            id1 = p.ID1.ToString();
        //    }
        //    if (p.ID2.ToString().Length == 1)
        //        id2 = "0" + p.ID2;
        //    else
        //        id2 = p.ID2.ToString();
        ...
        //        isValid = false;
        //    else if (ValidationIdNationalCompteurNaissance(id1, m, f) != "")
        //        isValid = false;
        //    else if (ValidationIdNationalDigit(id2, p.DateNaiss, id1, idDate) != "")
        //        isValid = false;
        //    return isValid;
        //}
        public static bool IsPatientValid(Patient p)
