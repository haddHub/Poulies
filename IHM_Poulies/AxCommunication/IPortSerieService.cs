...
namespace AxCommunication
{
    ...
    public delegate void onVitesseDataReceived(object sender, VitesseDataModel e);
    public delegate void onVitesse2DataReceived(object sender, Vitesse2DataModel e);
