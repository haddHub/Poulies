...
namespace AxData
{
    public static class PatientData
    {
        ...
        #region Modification
        //public static void ModificationPatient(Patient pat)
        //{
        //    if (conn == null)
        //        context = new ReaPlanDBEntities();
        //    else
        ...
        //    string dossier = "Files/Patients/" + singlePatient.Patient.Nom + singlePatient.Patient.Prenom + singlePatient.Patient.DateDeNaissance.ToString().Replace("/", string.Empty);
        //    string newDossier = "Files/Patients/" + pat.Nom + pat.Prenom + pat.DateNaiss.ToShortDateString().ToString().Replace("/", string.Empty);
        ...
        //        {
        //            patient.Nom = pat.Nom;
        //            patient.Prenom = pat.Prenom;
        //            patient.DateNaissance = pat.DateNaiss;
        //            patient.Poids = (decimal)pat.Poid;
        //            patient.Taille = pat.Taille;
        //            patient.Sexe = pat.Sexe.ToString();
        //            patient.Id1 = pat.ID1;
        //            patient.Id2 = pat.ID2;
        //            context.SaveChanges();
        //        }
