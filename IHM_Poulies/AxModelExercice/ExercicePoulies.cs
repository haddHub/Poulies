...
namespace AxModelExercice
{
    ...
    public class ExercicePoulies : Circle
    {
        ...
        public double ValeurSliderAssist { get; set; }
        ...
        private void DefinirConfig()
        {
            if (this.TypeExercice == TypeExercicePoulies.Entrainement)
            {
                if (this.Ressort == TypeRessort.AvecRessort)
                {
                    ...
                    {
                        double newValeur = (this.ValeurSliderAssist * (210.0 / 100.0));
                        this.ConfigInteraction.KInteracL = (byte)newValeur;
                        this.ConfigInteraction.KInteractR = (byte)newValeur;
                    }
