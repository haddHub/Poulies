...
namespace AxViewModel
{
    ...
    public class MainPViewModel : ViewModelBase
    {
        ...
        void _portSerieService_PositionDataReceived(object sender, PositionDataModel e)
        {
            //lock (locker)
            //{
            _positionUiBuffer.PositionX = EchelleUtils.MiseEchelleXPosition(e.PositionX);
            _positionUiBuffer.PositionY = EchelleUtils.MiseEchelleYPosition(e.PositionY);
            //}
        }
        ...
        void _portSerieService_Position2DataReceived(object sender, Position2DataModel e)
        {
            //lock (locker)
            //{
            _position2UiBuffer.PositionX = EchelleUtils.MiseEchelleXPosition2(e.PositionX);
            _position2UiBuffer.PositionY = EchelleUtils.MiseEchelleYPosition2(e.PositionY);
            //}
        }
