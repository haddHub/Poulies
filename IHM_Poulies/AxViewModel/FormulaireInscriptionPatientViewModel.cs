    ...
    public class FormulaireInscriptionPatientViewModel : ViewModelBase,IDataErrorInfo
    {
        ...
        #region methode
            ...
            private void SavePatient()
            {
                ...
                //    Patient patient = new Patient(NomPatient, PrenomPatient, DateNaiss, sexe, TaillePatient, PoidPatient, id1Int, id2Int);
            ...
            //                    if (ID2.Equals("") == false)
            //                    {
            //                        bool isChar = ID2.Any(i => char.IsLetter(i));
            //                        if (isChar == false)
            //                        {
            //                            p.ID2 = Convert.ToInt32(ID2);
            //                        }
            //                    }
            //                }
